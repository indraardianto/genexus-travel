...
namespace GeneXus.Programs {
   public class viewcountry : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewcountry( )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510213375", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Citywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void E110F2( )
      {
         ...
         {
            A9CountryId = H000F3_A9CountryId[0];
            A10CountryName = H000F3_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            AV16GXLvl6 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "City") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Citywc_Component) != 0 )
            {
               ...
               WebComp_Citywc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12CountryId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510213397", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcountry.js", "?202361510213397", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CountryId',fld:'vCOUNTRYID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A10CountryName',fld:'COUNTRYNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         hsh = "";
         H000F3_A9CountryId = new short[1] ;
         H000F3_A10CountryName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcountry__default(),
            new Object[][] {
                new Object[] {
               H000F2_A9CountryId, H000F2_A10CountryName
               }
               , new Object[] {
               H000F3_A9CountryId, H000F3_A10CountryName
               }
            }
         );
      ...
      private short[] H000F3_A9CountryId ;
      private string[] H000F3_A10CountryName ;
   ...
   public class viewcountry__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000F3", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
