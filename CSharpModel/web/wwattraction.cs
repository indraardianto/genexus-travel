...
namespace GeneXus.Programs {
   public class wwattraction : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               nRC_GXsfl_56 = (int)(NumberUtil.Val( GetPar( "nRC_GXsfl_56"), "."));
               nGXsfl_56_idx = (int)(NumberUtil.Val( GetPar( "nGXsfl_56_idx"), "."));
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11AttractionName, AV15CountryName, AV16OrderedBy, AV14ADVANCED_LABEL_TEMPLATE, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510213543", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_56", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_56), 8, 0, ".", "")));
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(56), 2, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, bttBtntoggle_Tooltiptext, "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110k1_client"+"'", TempTags, "", 2, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Attractions", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lbllbl15_Internalname, "", "", "", lbllbl15_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "navbar-brand", 0, "", 1, 1, 0, 0, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(56), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWAttraction.htm");
            context.WriteHtmlText( "</li>") ;
            context.WriteHtmlText( "<li>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'',0)\"";
            ClassString = "ActionButtons";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnattractionlist_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(56), 2, 0)+","+"null"+");", "Attractions PDF", bttBtnattractionlist_Jsonclick, 5, "Attractions PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOATTRACTIONLIST\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWAttraction.htm");
            context.WriteHtmlText( "</li>") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'" + sGXsfl_56_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavAttractionname_Internalname, StringUtil.RTrim( AV11AttractionName), StringUtil.RTrim( context.localUtil.Format( AV11AttractionName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavAttractionname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavAttractionname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblorderby_Internalname, lblLblorderby_Caption, "", "", lblLblorderby_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120k1_client"+"'", "", "WWAdvancedLabel WWOrderByLabel", 7, "", 1, 1, 0, 1, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby1_Internalname, "Name", "", "", lblOrderby1_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY1.CLICK."+"'", "", lblOrderby1_Class, 5, "", 1, 1, 0, 0, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-lg-6 OrdersCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby2_Internalname, "Country", "", "", lblOrderby2_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY2.CLICK."+"'", "", lblOrderby2_Class, 5, "", 1, 1, 0, 0, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcountrynamefilter_Internalname, lblLblcountrynamefilter_Caption, "", "", lblLblcountrynamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCountryname_Internalname, "Country Name", "col-sm-3 FilterComboAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 48,'',false,'" + sGXsfl_56_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCountryname_Internalname, StringUtil.RTrim( AV15CountryName), StringUtil.RTrim( context.localUtil.Format( AV15CountryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCountryname_Jsonclick, 0, "FilterComboAttribute", "", "", "", "", edtavCountryname_Visible, edtavCountryname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               context.WriteHtmlText( "<div id=\""+"GridContainer"+"DivS\" data-gxgridid=\"56\">") ;
               sStyleString = "";
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A7AttractionId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A8AttractionName));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtAttractionName_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A10CountryName));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtCountryName_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A16CityName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A12CategoryName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( A13AttractionPhoto));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A18AttractionAddress);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17Trips), 4, 0, ".", "")));
               GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavTrips_Enabled), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'DOATTRACTIONLIST'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'DoAttractionList' */
                              E150K2 ();
                           }
                        ...
                        else
                        {
                           ...
                           {
                              nGXsfl_56_idx = (int)(NumberUtil.Val( sEvtType, "."));
                              ...
                              AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40001AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_56_Refreshing);
                              ...
                              AV17Trips = (short)(context.localUtil.CToN( cgiGet( edtavTrips_Internalname), ".", ","));
                              AssignAttri("", false, edtavTrips_Internalname, StringUtil.LTrimStr( (decimal)(AV17Trips), 4, 0));
      ...
      {
         /* GeneXus formulas. */
         AV20Pgmname = "WWAttraction";
         context.Gx_err = 0;
         edtavTrips_Enabled = 0;
         AssignProp("", false, edtavTrips_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavTrips_Enabled), 5, 0), !bGXsfl_56_Refreshing);
         edtavUpdate_Enabled = 0;
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_56_Refreshing);
         edtavDelete_Enabled = 0;
         AssignProp("", false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_56_Refreshing);
      }
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15CityId = H000K3_A15CityId[0];
               A11CategoryId = H000K3_A11CategoryId[0];
               n11CategoryId = H000K3_n11CategoryId[0];
               A9CountryId = H000K3_A9CountryId[0];
               A18AttractionAddress = H000K3_A18AttractionAddress[0];
               A40001AttractionPhoto_GXI = H000K3_A40001AttractionPhoto_GXI[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40001AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_56_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A12CategoryName = H000K3_A12CategoryName[0];
               A16CityName = H000K3_A16CityName[0];
               A10CountryName = H000K3_A10CountryName[0];
               A8AttractionName = H000K3_A8AttractionName[0];
               A7AttractionId = H000K3_A7AttractionId[0];
               A40000GXC1 = H000K3_A40000GXC1[0];
               n40000GXC1 = H000K3_n40000GXC1[0];
               A13AttractionPhoto = H000K3_A13AttractionPhoto[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40001AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_56_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A12CategoryName = H000K3_A12CategoryName[0];
               A10CountryName = H000K3_A10CountryName[0];
      ...
      protected void send_integrity_lvl_hashes0K2( )
      {
         GxWebStd.gx_hidden_field( context, "vADVANCED_LABEL_TEMPLATE", StringUtil.RTrim( AV14ADVANCED_LABEL_TEMPLATE));
         GxWebStd.gx_hidden_field( context, "gxhash_vADVANCED_LABEL_TEMPLATE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14ADVANCED_LABEL_TEMPLATE, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ATTRACTIONID"+"_"+sGXsfl_56_idx, GetSecureSignedToken( sGXsfl_56_idx, context.localUtil.Format( (decimal)(A7AttractionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H000K5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_56 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_56"), ".", ","));
      ...
      protected void E180K2( )
      {
         /* Start Routine */
         returnInSub = false;
         if ( ! new isauthorized(context).executeUdp(  AV20Pgmname) )
         {
            CallWebObject(formatLink("notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV20Pgmname))}, new string[] {"GxObject"}) );
      ...
      protected void E190K2( )
      {
         ...
         if ( AV16OrderedBy == 1 )
         {
            lblLblorderby_Caption = StringUtil.Format( AV14ADVANCED_LABEL_TEMPLATE, "Ordered By", "Name", "", "", "", "", "", "", "");
            AssignProp("", false, lblLblorderby_Internalname, "Caption", lblLblorderby_Caption, true);
         }
         else if ( AV16OrderedBy == 2 )
         {
            lblLblorderby_Caption = StringUtil.Format( AV14ADVANCED_LABEL_TEMPLATE, "Ordered By", "Country", "", "", "", "", "", "", "");
            AssignProp("", false, lblLblorderby_Internalname, "Caption", lblLblorderby_Caption, true);
         }
      ...
      {
         /* 'DoAttractionList' Routine */
         returnInSub = false;
         CallWebObject(formatLink("aattractionsreport.aspx") );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236151021365", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwattraction.js", "?20236151021365", false, true);
         /* End function include_jscripts */
      }

      protected void SubsflControlProps_562( )
      {
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_56_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_56_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_56_idx;
         edtCityName_Internalname = "CITYNAME_"+sGXsfl_56_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_56_idx;
         edtAttractionPhoto_Internalname = "ATTRACTIONPHOTO_"+sGXsfl_56_idx;
         edtAttractionAddress_Internalname = "ATTRACTIONADDRESS_"+sGXsfl_56_idx;
         edtavTrips_Internalname = "vTRIPS_"+sGXsfl_56_idx;
      ...
      {
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_56_fel_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_56_fel_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_56_fel_idx;
         edtCityName_Internalname = "CITYNAME_"+sGXsfl_56_fel_idx;
         edtCategoryName_Internalname = "CATEGORYNAME_"+sGXsfl_56_fel_idx;
         edtAttractionPhoto_Internalname = "ATTRACTIONPHOTO_"+sGXsfl_56_fel_idx;
         edtAttractionAddress_Internalname = "ATTRACTIONADDRESS_"+sGXsfl_56_fel_idx;
         edtavTrips_Internalname = "vTRIPS_"+sGXsfl_56_fel_idx;
      ...
      protected void sendrow_562( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_56_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAttractionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7AttractionId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A7AttractionId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAttractionId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)56,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtAttractionPhoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A13AttractionPhoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavTrips_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17Trips), 4, 0, ".", "")),StringUtil.LTrim( ((edtavTrips_Enabled!=0) ? context.localUtil.Format( (decimal)(AV17Trips), "ZZZ9") : context.localUtil.Format( (decimal)(AV17Trips), "ZZZ9"))),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavTrips_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(int)edtavTrips_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)56,(short)1,(short)-1,(short)0,(bool)true,(string)"TripsAmount",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         bttBtnattractionlist_Internalname = "BTNATTRACTIONLIST";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         ...
         setEventMetadata("LBLORDERBY.CLICK","{handler:'E120K1',iparms:[{av:'divOrderbycontainer_Class',ctrl:'ORDERBYCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLORDERBY.CLICK",",oparms:[{av:'divOrderbycontainer_Class',ctrl:'ORDERBYCONTAINER',prop:'Class'}]}");
         setEventMetadata("ORDERBY1.CLICK","{handler:'E160K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("ORDERBY1.CLICK",",oparms:[{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'lblOrderby1_Class',ctrl:'ORDERBY1',prop:'Class'},{av:'lblOrderby2_Class',ctrl:'ORDERBY2',prop:'Class'},{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         setEventMetadata("ORDERBY2.CLICK","{handler:'E170K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("ORDERBY2.CLICK",",oparms:[{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'lblOrderby1_Class',ctrl:'ORDERBY1',prop:'Class'},{av:'lblOrderby2_Class',ctrl:'ORDERBY2',prop:'Class'},{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         setEventMetadata("LBLCOUNTRYNAMEFILTER.CLICK","{handler:'E130K1',iparms:[{av:'divCountrynamefiltercontainer_Class',ctrl:'COUNTRYNAMEFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLCOUNTRYNAMEFILTER.CLICK",",oparms:[{av:'divCountrynamefiltercontainer_Class',ctrl:'COUNTRYNAMEFILTERCONTAINER',prop:'Class'},{av:'edtavCountryname_Visible',ctrl:'vCOUNTRYNAME',prop:'Visible'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E200K2',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'A9CountryId',fld:'COUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAttractionName_Link',ctrl:'ATTRACTIONNAME',prop:'Link'},{av:'edtCountryName_Link',ctrl:'COUNTRYNAME',prop:'Link'},{av:'AV17Trips',fld:'vTRIPS',pic:'ZZZ9'},{av:'A40000GXC1',fld:'GXC1',pic:'999999999'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E140K2',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("'DOATTRACTIONLIST'","{handler:'E150K2',iparms:[]");
         setEventMetadata("'DOATTRACTIONLIST'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',hsh:true},{av:'AV15CountryName',fld:'vCOUNTRYNAME',pic:''}]");
         setEventMetadata("GRID_LASTPAGE",",oparms:[{av:'lblLblorderby_Caption',ctrl:'LBLORDERBY',prop:'Caption'},{av:'lblLblcountrynamefilter_Caption',ctrl:'LBLCOUNTRYNAMEFILTER',prop:'Caption'}]}");
      ...
      public override void initialize( )
      {
         ...
         bttBtnattractionlist_Jsonclick = "";
         ...
         lV11AttractionName = "";
         lV15CountryName = "";
         H000K3_A15CityId = new short[1] ;
         H000K3_A11CategoryId = new short[1] ;
         H000K3_n11CategoryId = new bool[] {false} ;
         H000K3_A9CountryId = new short[1] ;
         H000K3_A18AttractionAddress = new string[] {""} ;
         H000K3_A40001AttractionPhoto_GXI = new string[] {""} ;
         H000K3_A12CategoryName = new string[] {""} ;
         H000K3_A16CityName = new string[] {""} ;
         H000K3_A10CountryName = new string[] {""} ;
         H000K3_A8AttractionName = new string[] {""} ;
         H000K3_A7AttractionId = new short[1] ;
         H000K3_A40000GXC1 = new int[1] ;
         H000K3_n40000GXC1 = new bool[] {false} ;
         H000K3_A13AttractionPhoto = new string[] {""} ;
         H000K5_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwattraction__default(),
            new Object[][] {
                new Object[] {
               H000K3_A15CityId, H000K3_A11CategoryId, H000K3_n11CategoryId, H000K3_A9CountryId, H000K3_A18AttractionAddress, H000K3_A40001AttractionPhoto_GXI, H000K3_A12CategoryName, H000K3_A16CityName, H000K3_A10CountryName, H000K3_A8AttractionName,
               H000K3_A7AttractionId, H000K3_A40000GXC1, H000K3_n40000GXC1, H000K3_A13AttractionPhoto
               }
               , new Object[] {
               H000K5_AGRID_nRecordCount
               }
            }
         );
         AV20Pgmname = "WWAttraction";
      ...
      private string bttBtnattractionlist_Internalname ;
      private string bttBtnattractionlist_Jsonclick ;
      ...
      private short[] H000K3_A15CityId ;
      private short[] H000K3_A11CategoryId ;
      private bool[] H000K3_n11CategoryId ;
      private short[] H000K3_A9CountryId ;
      private string[] H000K3_A18AttractionAddress ;
      private string[] H000K3_A40001AttractionPhoto_GXI ;
      private string[] H000K3_A12CategoryName ;
      private string[] H000K3_A16CityName ;
      private string[] H000K3_A10CountryName ;
      private string[] H000K3_A8AttractionName ;
      private short[] H000K3_A7AttractionId ;
      private int[] H000K3_A40000GXC1 ;
      private bool[] H000K3_n40000GXC1 ;
      private string[] H000K3_A13AttractionPhoto ;
      private long[] H000K5_AGRID_nRecordCount ;
   ...
   public class wwattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV16OrderedBy )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[CityId], T1.[CategoryId], T1.[CountryId], T1.[AttractionAddress], T1.[AttractionPhoto_GXI], T2.[CategoryName], T4.[CityName], T3.[CountryName], T1.[AttractionName], T1.[AttractionId], COALESCE( T5.[GXC1], 0) AS GXC1, T1.[AttractionPhoto]";
         sFromString = " FROM (((([Attraction] T1 LEFT JOIN [Category] T2 ON T2.[CategoryId] = T1.[CategoryId]) INNER JOIN [Country] T3 ON T3.[CountryId] = T1.[CountryId]) INNER JOIN [CountryCity] T4 ON T4.[CountryId] = T1.[CountryId] AND T4.[CityId] = T1.[CityId]) LEFT JOIN (SELECT COUNT(*) AS GXC1, T6.[AttractionId] FROM ([TripAttraction] T6 INNER JOIN [Trip] T7 ON T7.[TripId] = T6.[TripId]) GROUP BY T6.[AttractionId] ) T5 ON T5.[AttractionId] = T1.[AttractionId])";
         sOrderString = "";
      ...
      protected Object[] conditional_H000K5( IGxContext context ,
                                             string AV11AttractionName ,
                                             string AV15CountryName ,
                                             string A8AttractionName ,
                                             string A10CountryName ,
                                             short AV16OrderedBy )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (((([Attraction] T1 LEFT JOIN [Category] T4 ON T4.[CategoryId] = T1.[CategoryId]) INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) INNER JOIN [CountryCity] T3 ON T3.[CountryId] = T1.[CountryId] AND T3.[CityId] = T1.[CityId]) LEFT JOIN (SELECT COUNT(*) AS GXC1, T6.[AttractionId] FROM ([TripAttraction] T6 INNER JOIN [Trip] T7 ON T7.[TripId] = T6.[TripId]) GROUP BY T6.[AttractionId] ) T5 ON T5.[AttractionId] = T1.[AttractionId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11AttractionName)) )
         {
            AddWhere(sWhereString, "(T1.[AttractionName] like @lV11AttractionName)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000K3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H000K5(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000K3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000K5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
