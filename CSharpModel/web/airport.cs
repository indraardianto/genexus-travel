...
namespace GeneXus.Programs {
   public class airport : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Airport", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, 0, "HLP_Airport.htm");
         ...
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtAirportId_Internalname+"\"", "", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtAirportId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A20AirportId), 4, 0, ".", "")), StringUtil.LTrim( ((edtAirportId_Enabled!=0) ? context.localUtil.Format( (decimal)(A20AirportId), "ZZZ9") : context.localUtil.Format( (decimal)(A20AirportId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAirportId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAirportId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtAirportName_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         ...
         GxWebStd.gx_single_line_edit( context, edtAirportName_Internalname, StringUtil.RTrim( A21AirportName), StringUtil.RTrim( context.localUtil.Format( A21AirportName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAirportName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAirportName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCountryName_Internalname, StringUtil.RTrim( A10CountryName), StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCityName_Internalname, StringUtil.RTrim( A16CityName), StringUtil.RTrim( context.localUtil.Format( A16CityName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCityName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCityName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Airport.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z20AirportId = (short)(context.localUtil.CToN( cgiGet( "Z20AirportId"), ".", ","));
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A20AirportId = (short)(NumberUtil.Val( GetPar( "AirportId"), "."));
               AssignAttri("", false, "A20AirportId", StringUtil.LTrimStr( (decimal)(A20AirportId), 4, 0));
               getEqualNoModal( ) ;
               Gx_mode = "DSP";
               AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void CheckOptimisticConcurrency067( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z21AirportName, T00062_A21AirportName[0]) != 0 ) || ( Z9CountryId != T00062_A9CountryId[0] ) || ( Z15CityId != T00062_A15CityId[0] ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A21AirportName, A9CountryId, A15CityId});
                     A20AirportId = T000612_A20AirportId[0];
                     AssignAttri("", false, "A20AirportId", StringUtil.LTrimStr( (decimal)(A20AirportId), 4, 0));
                     pr_default.close(10);
                     dsDefault.SmartCacheProvider.SetUpdated("Airport");
                     if ( AnyError == 0 )
                     {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(11, new Object[] {A21AirportName, A9CountryId, A15CityId, A20AirportId});
                     pr_default.close(11);
                     dsDefault.SmartCacheProvider.SetUpdated("Airport");
      ...
      protected void OnDeleteControls067( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(15, new Object[] {A20AirportId});
            ...
            pr_default.execute(16, new Object[] {A20AirportId});
      ...
      public void ScanStart067( )
      {
         ...
         {
            RcdFound7 = 1;
            A20AirportId = T000619_A20AirportId[0];
            AssignAttri("", false, "A20AirportId", StringUtil.LTrimStr( (decimal)(A20AirportId), 4, 0));
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510212829", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z21AirportName", StringUtil.RTrim( Z21AirportName));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510212834", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("airport.js", "?202361510212834", false, true);
      ...
      public void Valid_Airportid( )
      {
         ...
         AssignAttri("", false, "A21AirportName", StringUtil.RTrim( A21AirportName));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_AIRPORTID",",oparms:[{av:'A21AirportName',fld:'AIRPORTNAME',pic:''},{av:'A9CountryId',fld:'COUNTRYID',pic:'ZZZ9'},{av:'A15CityId',fld:'CITYID',pic:'ZZZ9'},{av:'A10CountryName',fld:'COUNTRYNAME',pic:''},{av:'A16CityName',fld:'CITYNAME',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z20AirportId'},{av:'Z21AirportName'},{av:'Z9CountryId'},{av:'Z15CityId'},{av:'Z10CountryName'},{av:'Z16CityName'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
      ...
      public override void initialize( )
      {
         ...
         T000617_A19FlightId = new short[1] ;
         T000618_A19FlightId = new short[1] ;
         T000619_A20AirportId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ21AirportName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.airport__default(),
            new Object[][] {
                new Object[] {
               T00062_A20AirportId, T00062_A21AirportName, T00062_A9CountryId, T00062_A15CityId
               }
               , new Object[] {
               T00063_A20AirportId, T00063_A21AirportName, T00063_A9CountryId, T00063_A15CityId
               }
               , new Object[] {
               ...
               , new Object[] {
               T00066_A20AirportId, T00066_A21AirportName, T00066_A10CountryName, T00066_A16CityName, T00066_A9CountryId, T00066_A15CityId
               }
               , new Object[] {
      ...
      private short[] T000617_A19FlightId ;
      private short[] T000618_A19FlightId ;
      private short[] T000619_A20AirportId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000612", "INSERT INTO [Airport]([AirportName], [CountryId], [CityId]) VALUES(@AirportName, @CountryId, @CityId); SELECT SCOPE_IDENTITY()", GxErrorMask.GX_NOMASK,prmT000612)
             ...
             ,new CursorDef("T000617", "SELECT TOP 1 [FlightId] FROM [Flight] WHERE [FlightArrivalAirportId] = @AirportId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000617,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000618", "SELECT TOP 1 [FlightId] FROM [Flight] WHERE [FlightDepartureAirportId] = @AirportId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000618,1, GxCacheFrequency.OFF ,true,true )
