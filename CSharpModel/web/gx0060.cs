...
namespace GeneXus.Programs {
   public class gx0060 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV6cFlightId = (short)(NumberUtil.Val( GetPar( "cFlightId"), "."));
               AV7cFlightDepartureAirportId = (short)(NumberUtil.Val( GetPar( "cFlightDepartureAirportId"), "."));
               AV8cFlightArrivalAirportId = (short)(NumberUtil.Val( GetPar( "cFlightArrivalAirportId"), "."));
               AV11cFlightPrice = NumberUtil.Val( GetPar( "cFlightPrice"), ".");
               AV12cFlightDiscountPercentage = (short)(NumberUtil.Val( GetPar( "cFlightDiscountPercentage"), "."));
               AV13cAirlineId = (short)(NumberUtil.Val( GetPar( "cAirlineId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
            ...
            {
               AV9pFlightId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510213916", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0060.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlightId,4,0))}, new string[] {"pFlightId"}) +"\">") ;
      ...
      {
         return formatLink("gx0060.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlightId,4,0))}, new string[] {"pFlightId"})  ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightidfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightidfilter_Internalname, "Flight Id", "", "", lblLblflightidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cFlightId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCflightid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cFlightId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cFlightId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightid_Visible, edtavCflightid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightdepartureairportidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightdepartureairportidfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightdepartureairportidfilter_Internalname, "Flight Departure Airport Id", "", "", lblLblflightdepartureairportidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightdepartureairportid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cFlightDepartureAirportId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCflightdepartureairportid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV7cFlightDepartureAirportId), "ZZZ9") : context.localUtil.Format( (decimal)(AV7cFlightDepartureAirportId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightdepartureairportid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightdepartureairportid_Visible, edtavCflightdepartureairportid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightarrivalairportidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightarrivalairportidfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightarrivalairportidfilter_Internalname, "Flight Arrival Airport Id", "", "", lblLblflightarrivalairportidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightarrivalairportid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cFlightArrivalAirportId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCflightarrivalairportid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cFlightArrivalAirportId), "ZZZ9") : context.localUtil.Format( (decimal)(AV8cFlightArrivalAirportId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightarrivalairportid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightarrivalairportid_Visible, edtavCflightarrivalairportid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightpricefiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightpricefiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightpricefilter_Internalname, "Flight Price", "", "", lblLblflightpricefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightprice_Internalname, StringUtil.LTrim( StringUtil.NToC( AV11cFlightPrice, 9, 2, ".", "")), StringUtil.LTrim( ((edtavCflightprice_Enabled!=0) ? context.localUtil.Format( AV11cFlightPrice, "ZZZZZ9.99") : context.localUtil.Format( AV11cFlightPrice, "ZZZZZ9.99"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightprice_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightprice_Visible, edtavCflightprice_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightdiscountpercentagefiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightdiscountpercentagefiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightdiscountpercentagefilter_Internalname, "Flight Discount Percentage", "", "", lblLblflightdiscountpercentagefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightdiscountpercentage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cFlightDiscountPercentage), 3, 0, ".", "")), StringUtil.LTrim( ((edtavCflightdiscountpercentage_Enabled!=0) ? context.localUtil.Format( (decimal)(AV12cFlightDiscountPercentage), "ZZ9") : context.localUtil.Format( (decimal)(AV12cFlightDiscountPercentage), "ZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightdiscountpercentage_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightdiscountpercentage_Visible, edtavCflightdiscountpercentage_Enabled, 0, "text", "1", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divAirlineidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divAirlineidfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlineidfilter_Internalname, "Airline Id", "", "", lblLblairlineidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCairlineid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13cAirlineId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCairlineid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV13cAirlineId), "ZZZ9") : context.localUtil.Format( (decimal)(AV13cAirlineId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCairlineid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCairlineid_Visible, edtavCairlineid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e170m1_client"+"'", TempTags, "", 2, "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A19FlightId), 4, 0, ".", "")));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtFlightId_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22FlightDepartureAirportId), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24FlightArrivalAirportId), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A34FlightPrice, 9, 2, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A35FlightDiscountPercentage), 3, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A37AirlineId), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
         ...
         if ( wbEnd == 74 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV13cAirlineId ,
                                                 A22FlightDepartureAirportId ,
                                                 A24FlightArrivalAirportId ,
                                                 A34FlightPrice ,
                                                 A35FlightDiscountPercentage ,
                                                 A37AirlineId ,
                                                 AV6cFlightId } ,
                                                 new int[]{
            ...
            {
               A37AirlineId = H000M2_A37AirlineId[0];
               n37AirlineId = H000M2_n37AirlineId[0];
               A35FlightDiscountPercentage = H000M2_A35FlightDiscountPercentage[0];
               A34FlightPrice = H000M2_A34FlightPrice[0];
               A24FlightArrivalAirportId = H000M2_A24FlightArrivalAirportId[0];
               A22FlightDepartureAirportId = H000M2_A22FlightDepartureAirportId[0];
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV6cFlightId = (short)(context.localUtil.CToN( cgiGet( edtavCflightid_Internalname), ".", ","));
               AssignAttri("", false, "AV6cFlightId", StringUtil.LTrimStr( (decimal)(AV6cFlightId), 4, 0));
            }
            ...
            {
               AV7cFlightDepartureAirportId = (short)(context.localUtil.CToN( cgiGet( edtavCflightdepartureairportid_Internalname), ".", ","));
               AssignAttri("", false, "AV7cFlightDepartureAirportId", StringUtil.LTrimStr( (decimal)(AV7cFlightDepartureAirportId), 4, 0));
            }
            ...
            {
               AV8cFlightArrivalAirportId = (short)(context.localUtil.CToN( cgiGet( edtavCflightarrivalairportid_Internalname), ".", ","));
               AssignAttri("", false, "AV8cFlightArrivalAirportId", StringUtil.LTrimStr( (decimal)(AV8cFlightArrivalAirportId), 4, 0));
            }
            ...
            {
               AV12cFlightDiscountPercentage = (short)(context.localUtil.CToN( cgiGet( edtavCflightdiscountpercentage_Internalname), ".", ","));
               AssignAttri("", false, "AV12cFlightDiscountPercentage", StringUtil.LTrimStr( (decimal)(AV12cFlightDiscountPercentage), 3, 0));
            }
            ...
            {
               AV13cAirlineId = (short)(context.localUtil.CToN( cgiGet( edtavCairlineid_Internalname), ".", ","));
               AssignAttri("", false, "AV13cAirlineId", StringUtil.LTrimStr( (decimal)(AV13cAirlineId), 4, 0));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510213970", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0060.js", "?202361510213970", false, true);
      ...
      protected void sendrow_742( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_74_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtFlightDiscountPercentage_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A35FlightDiscountPercentage), 3, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A35FlightDiscountPercentage), "ZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtFlightDiscountPercentage_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)3,(short)0,(short)0,(short)74,(short)1,(short)-1,(short)0,(bool)true,(string)"Percentage",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAirlineId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A37AirlineId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A37AirlineId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAirlineId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)74,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
      ...
      public override void initialize_properties( )
      {
         ...
         divFlightdiscountpercentagefiltercontainer_Class = "AdvancedContainerItem";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLFLIGHTDEPARTUREAIRPORTIDFILTER.CLICK","{handler:'E120M1',iparms:[{av:'divFlightdepartureairportidfiltercontainer_Class',ctrl:'FLIGHTDEPARTUREAIRPORTIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFLIGHTARRIVALAIRPORTIDFILTER.CLICK","{handler:'E130M1',iparms:[{av:'divFlightarrivalairportidfiltercontainer_Class',ctrl:'FLIGHTARRIVALAIRPORTIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFLIGHTDISCOUNTPERCENTAGEFILTER.CLICK","{handler:'E150M1',iparms:[{av:'divFlightdiscountpercentagefiltercontainer_Class',ctrl:'FLIGHTDISCOUNTPERCENTAGEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLAIRLINEIDFILTER.CLICK","{handler:'E160M1',iparms:[{av:'divAirlineidfiltercontainer_Class',ctrl:'AIRLINEIDFILTERCONTAINER',prop:'Class'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000M2_A37AirlineId = new short[1] ;
         H000M2_n37AirlineId = new bool[] {false} ;
         H000M2_A35FlightDiscountPercentage = new short[1] ;
         H000M2_A34FlightPrice = new decimal[1] ;
         H000M2_A24FlightArrivalAirportId = new short[1] ;
         H000M2_A22FlightDepartureAirportId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0060__default(),
            new Object[][] {
                new Object[] {
               H000M2_A37AirlineId, H000M2_n37AirlineId, H000M2_A35FlightDiscountPercentage, H000M2_A34FlightPrice, H000M2_A24FlightArrivalAirportId, H000M2_A22FlightDepartureAirportId, H000M2_A19FlightId
               }
               , new Object[] {
      ...
      private short[] H000M2_A37AirlineId ;
      private bool[] H000M2_n37AirlineId ;
      private short[] H000M2_A35FlightDiscountPercentage ;
      private decimal[] H000M2_A34FlightPrice ;
      private short[] H000M2_A24FlightArrivalAirportId ;
      private short[] H000M2_A22FlightDepartureAirportId ;
   ...
   public class gx0060__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000M2( IGxContext context ,
                                             ...
                                             short AV12cFlightDiscountPercentage ,
                                             short AV13cAirlineId ,
                                             short A22FlightDepartureAirportId ,
                                             short A24FlightArrivalAirportId ,
                                             decimal A34FlightPrice ,
                                             short A35FlightDiscountPercentage ,
                                             short A37AirlineId ,
                                             short AV6cFlightId )
      {
