...
namespace GeneXus.Programs {
   public class gx0091 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         this.AV8pFlightId = aP0_pFlightId;
         this.AV9pFlightSeatId = 0 ;
         executePrivate();
         aP1_pFlightSeatId=this.AV9pFlightSeatId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV6cFlightSeatId = (short)(NumberUtil.Val( GetPar( "cFlightSeatId"), "."));
               cmbavCflightseatlocation.FromJSonString( GetNextPar( ));
               AV7cFlightSeatLocation = GetPar( "cFlightSeatLocation");
               AV8pFlightId = (short)(NumberUtil.Val( GetPar( "pFlightId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cFlightSeatId, AV7cFlightSeatLocation, AV8pFlightId) ;
            ...
            {
               AV8pFlightId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8pFlightId", StringUtil.LTrimStr( (decimal)(AV8pFlightId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9pFlightSeatId = (short)(NumberUtil.Val( GetPar( "pFlightSeatId"), "."));
                  AssignAttri("", false, "AV9pFlightSeatId", StringUtil.LTrimStr( (decimal)(AV9pFlightSeatId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202351710104639", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0091.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pFlightId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pFlightSeatId,4,0))}, new string[] {"pFlightId","pFlightSeatId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCFLIGHTSEATLOCATION", StringUtil.RTrim( AV7cFlightSeatLocation));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_34", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_34), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPFLIGHTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pFlightId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPFLIGHTSEATID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pFlightSeatId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx0091.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pFlightId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pFlightSeatId,4,0))}, new string[] {"pFlightId","pFlightSeatId"})  ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightseatidfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightseatidfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightseatidfilter_Internalname, "Flight Seat Id", "", "", lblLblflightseatidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0091.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCflightseatid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cFlightSeatId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCflightseatid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cFlightSeatId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cFlightSeatId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCflightseatid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCflightseatid_Visible, edtavCflightseatid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0091.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightseatlocationfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightseatlocationfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightseatlocationfilter_Internalname, "Flight Seat Location", "", "", lblLblflightseatlocationfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0091.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCflightseatlocation, cmbavCflightseatlocation_Internalname, StringUtil.RTrim( AV7cFlightSeatLocation), 1, cmbavCflightseatlocation_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavCflightseatlocation.Visible, cmbavCflightseatlocation.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 1, "HLP_Gx0091.htm");
            cmbavCflightseatlocation.CurrentValue = StringUtil.RTrim( AV7cFlightSeatLocation);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130p1_client"+"'", TempTags, "", 2, "HLP_Gx0091.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A40FlightSeatId), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A41FlightSeatLocation));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( cmbFlightSeatLocation.Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0091.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCFLIGHTSEATLOCATION"), AV7cFlightSeatLocation) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_FLIGHTSEATID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A40FlightSeatId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "FLIGHTSEATID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A40FlightSeatId), 4, 0, ".", "")));
      }
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV7cFlightSeatLocation = cmbavCflightseatlocation.getValidValue(AV7cFlightSeatLocation);
            AssignAttri("", false, "AV7cFlightSeatLocation", AV7cFlightSeatLocation);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavCflightseatlocation.CurrentValue = StringUtil.RTrim( AV7cFlightSeatLocation);
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cFlightSeatLocation = StringUtil.PadR( StringUtil.RTrim( AV7cFlightSeatLocation), 1, "%");
            /* Using cursor H000P2 */
            pr_default.execute(0, new Object[] {AV8pFlightId, AV6cFlightSeatId, lV7cFlightSeatLocation, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A19FlightId = H000P2_A19FlightId[0];
               A41FlightSeatLocation = H000P2_A41FlightSeatLocation[0];
               A40FlightSeatId = H000P2_A40FlightSeatId[0];
               /* Execute user event: Load */
               E150P2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_FLIGHTSEATID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A40FlightSeatId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cFlightSeatLocation = StringUtil.PadR( StringUtil.RTrim( AV7cFlightSeatLocation), 1, "%");
         /* Using cursor H000P3 */
         pr_default.execute(1, new Object[] {AV8pFlightId, AV6cFlightSeatId, lV7cFlightSeatLocation});
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV6cFlightSeatId = (short)(context.localUtil.CToN( cgiGet( edtavCflightseatid_Internalname), ".", ","));
               AssignAttri("", false, "AV6cFlightSeatId", StringUtil.LTrimStr( (decimal)(AV6cFlightSeatId), 4, 0));
            }
            ...
            AV7cFlightSeatLocation = cgiGet( cmbavCflightseatlocation_Internalname);
            AssignAttri("", false, "AV7cFlightSeatLocation", AV7cFlightSeatLocation);
      ...
      protected void E160P2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9pFlightSeatId = A40FlightSeatId;
         AssignAttri("", false, "AV9pFlightSeatId", StringUtil.LTrimStr( (decimal)(AV9pFlightSeatId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV9pFlightSeatId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9pFlightSeatId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pFlightId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV8pFlightId", StringUtil.LTrimStr( (decimal)(AV8pFlightId), 4, 0));
         AV9pFlightSeatId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV9pFlightSeatId", StringUtil.LTrimStr( (decimal)(AV9pFlightSeatId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202351710104665", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0091.js", "?202351710104665", false, true);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtFlightSeatId_Internalname = "FLIGHTSEATID_"+sGXsfl_34_idx;
         cmbFlightSeatLocation_Internalname = "FLIGHTSEATLOCATION_"+sGXsfl_34_idx;
         edtFlightId_Internalname = "FLIGHTID_"+sGXsfl_34_idx;
      }

      protected void SubsflControlProps_fel_342( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_34_fel_idx;
         edtFlightSeatId_Internalname = "FLIGHTSEATID_"+sGXsfl_34_fel_idx;
         cmbFlightSeatLocation_Internalname = "FLIGHTSEATLOCATION_"+sGXsfl_34_fel_idx;
         edtFlightId_Internalname = "FLIGHTID_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A40FlightSeatId), 4, 0, ".", "")))+"'"+"]);";
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtFlightSeatId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A40FlightSeatId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A40FlightSeatId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtFlightSeatId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)34,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "FLIGHTSEATLOCATION_" + sGXsfl_34_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cFlightSeatId',fld:'vCFLIGHTSEATID',pic:'ZZZ9'},{av:'cmbavCflightseatlocation'},{av:'AV7cFlightSeatLocation',fld:'vCFLIGHTSEATLOCATION',pic:''},{av:'AV8pFlightId',fld:'vPFLIGHTID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("LBLFLIGHTSEATIDFILTER.CLICK","{handler:'E110P1',iparms:[{av:'divFlightseatidfiltercontainer_Class',ctrl:'FLIGHTSEATIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFLIGHTSEATLOCATIONFILTER.CLICK","{handler:'E120P1',iparms:[{av:'divFlightseatlocationfiltercontainer_Class',ctrl:'FLIGHTSEATLOCATIONFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E160P2',iparms:[{av:'A40FlightSeatId',fld:'FLIGHTSEATID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9pFlightSeatId',fld:'vPFLIGHTSEATID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cFlightSeatId',fld:'vCFLIGHTSEATID',pic:'ZZZ9'},{av:'cmbavCflightseatlocation'},{av:'AV7cFlightSeatLocation',fld:'vCFLIGHTSEATLOCATION',pic:''},{av:'AV8pFlightId',fld:'vPFLIGHTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cFlightSeatId',fld:'vCFLIGHTSEATID',pic:'ZZZ9'},{av:'cmbavCflightseatlocation'},{av:'AV7cFlightSeatLocation',fld:'vCFLIGHTSEATLOCATION',pic:''},{av:'AV8pFlightId',fld:'vPFLIGHTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cFlightSeatId',fld:'vCFLIGHTSEATID',pic:'ZZZ9'},{av:'cmbavCflightseatlocation'},{av:'AV7cFlightSeatLocation',fld:'vCFLIGHTSEATLOCATION',pic:''},{av:'AV8pFlightId',fld:'vPFLIGHTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cFlightSeatId',fld:'vCFLIGHTSEATID',pic:'ZZZ9'},{av:'cmbavCflightseatlocation'},{av:'AV7cFlightSeatLocation',fld:'vCFLIGHTSEATLOCATION',pic:''},{av:'AV8pFlightId',fld:'vPFLIGHTID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV7cFlightSeatLocation = "";
         H000P2_A19FlightId = new short[1] ;
         H000P2_A41FlightSeatLocation = new string[] {""} ;
         H000P2_A40FlightSeatId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0091__default(),
            new Object[][] {
                new Object[] {
               H000P2_A19FlightId, H000P2_A41FlightSeatLocation, H000P2_A40FlightSeatId
               }
               , new Object[] {
      ...
      private short AV8pFlightId ;
      private short AV9pFlightSeatId ;
      private short wcpOAV8pFlightId ;
      ...
      private string AV7cFlightSeatLocation ;
      ...
      private string lV7cFlightSeatLocation ;
      ...
      private short[] H000P2_A19FlightId ;
      private string[] H000P2_A41FlightSeatLocation ;
      private short[] H000P2_A40FlightSeatId ;
   ...
   public class gx0091__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A19FlightId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [FlightId], [FlightSeatLocation], [FlightSeatId]";
         sFromString = " FROM [FlightSeat]";
         sOrderString = "";
         AddWhere(sWhereString, "([FlightId] = @AV8pFlightId and [FlightSeatId] >= @AV6cFlightSeatId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cFlightSeatLocation)) )
         {
            AddWhere(sWhereString, "([FlightSeatLocation] like @lV7cFlightSeatLocation)");
         }
         else
         {
            GXv_int1[2] = 1;
         }
         sOrderString += " ORDER BY [FlightId], [FlightSeatId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000P2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H000P3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8pFlightId",GXType.Int16,4,0) ,
          new ParDef("@AV6cFlightSeatId",GXType.Int16,4,0) ,
          new ParDef("@lV7cFlightSeatLocation",GXType.NChar,1,0) ,
