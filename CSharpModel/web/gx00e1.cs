...
namespace GeneXus.Programs {
   public class gx00e1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( short aP0_pTripId ,
                           out short aP1_pAttractionId )
      {
         this.AV7pTripId = aP0_pTripId;
         this.AV8pAttractionId = 0 ;
         executePrivate();
         aP1_pAttractionId=this.AV8pAttractionId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pTripId = (short)(NumberUtil.Val( GetPar( "pTripId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7pTripId) ;
            ...
            {
               AV7pTripId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7pTripId", StringUtil.LTrimStr( (decimal)(AV7pTripId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pAttractionId = (short)(NumberUtil.Val( GetPar( "pAttractionId"), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510214164", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00e1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pTripId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pAttractionId,4,0))}, new string[] {"pTripId","pAttractionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPTRIPID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pTripId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx00e1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pTripId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pAttractionId,4,0))}, new string[] {"pTripId","pAttractionId"})  ;
      }
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblattractionidfilter_Internalname, "Attraction Id", "", "", lblLblattractionidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11101_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00E1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12101_client"+"'", TempTags, "", 2, "HLP_Gx00E1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtAttractionId_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00E1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF102( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV7pTripId, AV6cAttractionId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A48TripId = H00102_A48TripId[0];
               A7AttractionId = H00102_A7AttractionId[0];
               /* Execute user event: Load */
               E14102 ();
      ...
      {
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV7pTripId, AV6cAttractionId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pTripId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pTripId", StringUtil.LTrimStr( (decimal)(AV7pTripId), 4, 0));
         AV8pAttractionId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV8pAttractionId", StringUtil.LTrimStr( (decimal)(AV8pAttractionId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510214183", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00e1.js", "?202361510214183", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtTripId_Internalname = "TRIPID_"+sGXsfl_24_idx;
      }
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtTripId_Internalname = "TRIPID_"+sGXsfl_24_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7pTripId',fld:'vPTRIPID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("LBLATTRACTIONIDFILTER.CLICK","{handler:'E11101',iparms:[{av:'divAttractionidfiltercontainer_Class',ctrl:'ATTRACTIONIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E15102',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pAttractionId',fld:'vPATTRACTIONID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7pTripId',fld:'vPTRIPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7pTripId',fld:'vPTRIPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7pTripId',fld:'vPTRIPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAttractionId',fld:'vCATTRACTIONID',pic:'ZZZ9'},{av:'AV7pTripId',fld:'vPTRIPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Tripid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00102_A48TripId = new short[1] ;
         H00102_A7AttractionId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00e1__default(),
            new Object[][] {
                new Object[] {
               H00102_A48TripId, H00102_A7AttractionId
               }
               , new Object[] {
      ...
      private short AV7pTripId ;
      private short AV8pAttractionId ;
      private short wcpOAV7pTripId ;
      ...
      private string edtAttractionId_Link ;
      ...
      private short[] H00102_A48TripId ;
      private short[] H00102_A7AttractionId ;
   ...
   public class gx00e1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7pTripId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT [TripId], [AttractionId] FROM [TripAttraction] WHERE [TripId] = @AV7pTripId and [AttractionId] >= @AV6cAttractionId ORDER BY [TripId], [AttractionId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00103", "SELECT COUNT(*) FROM [TripAttraction] WHERE [TripId] = @AV7pTripId and [AttractionId] >= @AV6cAttractionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
