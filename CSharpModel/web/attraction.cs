   ...
   public class attraction : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_18") == 0 )
         {
            ...
            gxLoad_18( A9CountryId, A15CityId) ;
            return  ;
         }
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV7AttractionId = (short)(NumberUtil.Val( GetPar( "AttractionId"), "."));
      ...
      protected void DrawControls( )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Attraction", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, 0, "HLP_Attraction.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtCountryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9CountryId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A9CountryId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryId_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Attraction.htm");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCountryName_Internalname, StringUtil.RTrim( A10CountryName), StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Attraction.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCityId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A15CityId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCityId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCityId_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Attraction.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "prompt.gif", "", context.GetTheme( )));
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCityName_Internalname, StringUtil.RTrim( A16CityName), StringUtil.RTrim( context.localUtil.Format( A16CityName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCityName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCityName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Attraction.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, StringUtil.RTrim( A12CategoryName), StringUtil.RTrim( context.localUtil.Format( A12CategoryName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Attraction.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Gx_mode = cgiGet( "Mode");
               N9CountryId = (short)(context.localUtil.CToN( cgiGet( "N9CountryId"), ".", ","));
               N15CityId = (short)(context.localUtil.CToN( cgiGet( "N15CityId"), ".", ","));
               N11CategoryId = (short)(context.localUtil.CToN( cgiGet( "N11CategoryId"), ".", ","));
               n11CategoryId = ((0==A11CategoryId) ? true : false);
               ...
               AV13Insert_CategoryId = (short)(context.localUtil.CToN( cgiGet( "vINSERT_CATEGORYID"), ".", ","));
      ...
      protected void E11022( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV9TrnContext.gxTpr_Transactionname, AV16Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            while ( AV17GXV1 <= AV9TrnContext.gxTpr_Attributes.Count )
            {
               ...
               {
                  AV11Insert_CountryId = (short)(NumberUtil.Val( AV14TrnContextAtt.gxTpr_Attributevalue, "."));
                  AssignAttri("", false, "AV11Insert_CountryId", StringUtil.LTrimStr( (decimal)(AV11Insert_CountryId), 4, 0));
               }
               else if ( StringUtil.StrCmp(AV14TrnContextAtt.gxTpr_Attributename, "CityId") == 0 )
               {
                  AV12Insert_CityId = (short)(NumberUtil.Val( AV14TrnContextAtt.gxTpr_Attributevalue, "."));
                  AssignAttri("", false, "AV12Insert_CityId", StringUtil.LTrimStr( (decimal)(AV12Insert_CityId), 4, 0));
               }
               else if ( StringUtil.StrCmp(AV14TrnContextAtt.gxTpr_Attributename, "CategoryId") == 0 )
               {
                  AV13Insert_CategoryId = (short)(NumberUtil.Val( AV14TrnContextAtt.gxTpr_Attributevalue, "."));
                  AssignAttri("", false, "AV13Insert_CategoryId", StringUtil.LTrimStr( (decimal)(AV13Insert_CategoryId), 4, 0));
               }
      ...
      protected void Load022( )
      {
         ...
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            A18AttractionAddress = T00027_A18AttractionAddress[0];
            AssignAttri("", false, "A18AttractionAddress", A18AttractionAddress);
      ...
      protected void CheckExtendedTable022( )
      {
         ...
         {
            GX_msglist.addItem("The attraction name must not be empty", 0, "ATTRACTIONNAME");
         }
         /* Using cursor T00024 */
         pr_default.execute(2, new Object[] {A9CountryId});
      ...
      protected void CheckOptimisticConcurrency022( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z8AttractionName, T00022_A8AttractionName[0]) != 0 ) || ( StringUtil.StrCmp(Z18AttractionAddress, T00022_A18AttractionAddress[0]) != 0 ) || ( Z9CountryId != T00022_A9CountryId[0] ) || ( Z15CityId != T00022_A15CityId[0] ) || ( Z11CategoryId != T00022_A11CategoryId[0] ) )
            {
      ...
      public void ScanStart022( )
      {
         ...
         {
            RcdFound2 = 1;
            A7AttractionId = T000224_A7AttractionId[0];
            AssignAttri("", false, "A7AttractionId", StringUtil.LTrimStr( (decimal)(A7AttractionId), 4, 0));
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510212599", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510212614", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("attraction.js", "?202361510212615", false, true);
      ...
      public override void initialize( )
      {
         ...
         T00027_A18AttractionAddress = new string[] {""} ;
         ...
         T000220_A16CityName = new string[] {""} ;
         T000221_A12CategoryName = new string[] {""} ;
         T000222_A48TripId = new short[1] ;
         T000222_A7AttractionId = new short[1] ;
         T000223_A44SupplierId = new short[1] ;
         T000223_A7AttractionId = new short[1] ;
         T000224_A7AttractionId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXCCtlgxBlob = "";
         T000225_A8AttractionName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.attraction__default(),
            new Object[][] {
                new Object[] {
               T00022_A7AttractionId, T00022_A8AttractionName, T00022_A40000AttractionPhoto_GXI, T00022_A18AttractionAddress, T00022_A9CountryId, T00022_A15CityId, T00022_A11CategoryId, T00022_n11CategoryId, T00022_A13AttractionPhoto
               }
               , new Object[] {
               T00023_A7AttractionId, T00023_A8AttractionName, T00023_A40000AttractionPhoto_GXI, T00023_A18AttractionAddress, T00023_A9CountryId, T00023_A15CityId, T00023_A11CategoryId, T00023_n11CategoryId, T00023_A13AttractionPhoto
               }
               , new Object[] {
               ...
               , new Object[] {
               T00027_A7AttractionId, T00027_A8AttractionName, T00027_A10CountryName, T00027_A16CityName, T00027_A12CategoryName, T00027_A40000AttractionPhoto_GXI, T00027_A18AttractionAddress, T00027_A9CountryId, T00027_A15CityId, T00027_A11CategoryId,
               ...
               , new Object[] {
               T000221_A12CategoryName
               }
               , new Object[] {
               T000222_A48TripId, T000222_A7AttractionId
               }
               , new Object[] {
               T000223_A44SupplierId, T000223_A7AttractionId
               }
               , new Object[] {
               T000224_A7AttractionId
               }
               , new Object[] {
               T000225_A8AttractionName
               }
            }
         );
         AV16Pgmname = "Attraction";
      ...
      private string[] T00027_A18AttractionAddress ;
      ...
      private string[] T000220_A16CityName ;
      private string[] T000221_A12CategoryName ;
      private short[] T000222_A48TripId ;
      private short[] T000222_A7AttractionId ;
      private short[] T000223_A44SupplierId ;
      private short[] T000223_A7AttractionId ;
      private short[] T000224_A7AttractionId ;
      private string[] T000225_A8AttractionName ;
   ...
   public class attraction__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00022", "SELECT [AttractionId], [AttractionName], [AttractionPhoto_GXI], [AttractionAddress], [CountryId], [CityId], [CategoryId], [AttractionPhoto] FROM [Attraction] WITH (UPDLOCK) WHERE [AttractionId] = @AttractionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00022,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00023", "SELECT [AttractionId], [AttractionName], [AttractionPhoto_GXI], [AttractionAddress], [CountryId], [CityId], [CategoryId], [AttractionPhoto] FROM [Attraction] WHERE [AttractionId] = @AttractionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00023,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T00027", "SELECT TM1.[AttractionId], TM1.[AttractionName], T2.[CountryName], T3.[CityName], T4.[CategoryName], TM1.[AttractionPhoto_GXI], TM1.[AttractionAddress], TM1.[CountryId], TM1.[CityId], TM1.[CategoryId], TM1.[AttractionPhoto] FROM ((([Attraction] TM1 INNER JOIN [Country] T2 ON T2.[CountryId] = TM1.[CountryId]) INNER JOIN [CountryCity] T3 ON T3.[CountryId] = TM1.[CountryId] AND T3.[CityId] = TM1.[CityId]) LEFT JOIN [Category] T4 ON T4.[CategoryId] = TM1.[CategoryId]) WHERE TM1.[AttractionId] = @AttractionId ORDER BY TM1.[AttractionId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00027,100, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T000215", "INSERT INTO [Attraction]([AttractionName], [AttractionPhoto], [AttractionPhoto_GXI], [AttractionAddress], [CountryId], [CityId], [CategoryId]) VALUES(@AttractionName, @AttractionPhoto, @AttractionPhoto_GXI, @AttractionAddress, @CountryId, @CityId, @CategoryId); SELECT SCOPE_IDENTITY()", GxErrorMask.GX_NOMASK,prmT000215)
             ,new CursorDef("T000216", "UPDATE [Attraction] SET [AttractionName]=@AttractionName, [AttractionAddress]=@AttractionAddress, [CountryId]=@CountryId, [CityId]=@CityId, [CategoryId]=@CategoryId  WHERE [AttractionId] = @AttractionId", GxErrorMask.GX_NOMASK,prmT000216)
             ,new CursorDef("T000217", "UPDATE [Attraction] SET [AttractionPhoto]=@AttractionPhoto, [AttractionPhoto_GXI]=@AttractionPhoto_GXI  WHERE [AttractionId] = @AttractionId", GxErrorMask.GX_NOMASK,prmT000217)
             ...
             ,new CursorDef("T000220", "SELECT [CityName] FROM [CountryCity] WHERE [CountryId] = @CountryId AND [CityId] = @CityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000220,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000221", "SELECT [CategoryName] FROM [Category] WHERE [CategoryId] = @CategoryId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000221,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000222", "SELECT TOP 1 [TripId], [AttractionId] FROM [TripAttraction] WHERE [AttractionId] = @AttractionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000222,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000223", "SELECT TOP 1 [SupplierId], [AttractionId] FROM [SupplierAttraction] WHERE [AttractionId] = @AttractionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000223,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000224", "SELECT [AttractionId] FROM [Attraction] ORDER BY [AttractionId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000224,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000225", "SELECT [AttractionName] FROM [Attraction] WHERE ([AttractionName] = @AttractionName) AND (Not ( [AttractionId] = @AttractionId)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000225,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
