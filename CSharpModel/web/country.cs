   ...
   public class country : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxNewRow_"+"Gridcountry_city") == 0 )
         {
            ...
            A17CountryLastLine = (short)(NumberUtil.Val( GetPar( "CountryLastLine"), "."));
      ...
      protected void DrawControls( )
      {
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCountryId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9CountryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCountryId_Enabled!=0) ? context.localUtil.Format( (decimal)(A9CountryId), "ZZZ9") : context.localUtil.Format( (decimal)(A9CountryId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Country.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCountryName_Internalname, StringUtil.RTrim( A10CountryName), StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCountryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCountryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Country.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxdraw_Gridcountry_city( )
      {
         ...
         Gridcountry_cityColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", "")));
         ...
         Gridcountry_cityColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         Gridcountry_cityColumn.AddObjectProperty("Value", StringUtil.RTrim( A16CityName));
         ...
         else if ( ( nKeyPressed == 3 ) || ( nKeyPressed == 4 ) || ( ( nKeyPressed == 1 ) && ( AnyError != 0 ) ) )
         {
            ...
            while ( nGXsfl_53_idx < nRC_GXsfl_53 )
            {
               ...
               ReadRow035( ) ;
               edtCityId_Enabled = (int)(context.localUtil.CToN( cgiGet( "CITYID_"+sGXsfl_53_idx+"Enabled"), ".", ","));
               AssignProp("", false, edtCityId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCityId_Enabled), 5, 0), !bGXsfl_53_Refreshing);
               edtCityName_Enabled = (int)(context.localUtil.CToN( cgiGet( "CITYNAME_"+sGXsfl_53_idx+"Enabled"), ".", ","));
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z17CountryLastLine = (short)(context.localUtil.CToN( cgiGet( "Z17CountryLastLine"), ".", ","));
               O17CountryLastLine = (short)(context.localUtil.CToN( cgiGet( "O17CountryLastLine"), ".", ","));
      ...
      protected void GetKey035( )
      {
         ...
         pr_default.execute(15, new Object[] {A9CountryId, A15CityId});
      ...
      {
         /* Using cursor T00033 */
         pr_default.execute(1, new Object[] {A9CountryId, A15CityId});
      ...
      protected void CheckOptimisticConcurrency035( )
      {
         ...
         {
            /* Using cursor T00032 */
            pr_default.execute(0, new Object[] {A9CountryId, A15CityId});
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(16, new Object[] {A9CountryId, A15CityId, A16CityName});
                     pr_default.close(16);
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     if ( AnyError == 0 )
                     {
                        ...
                        pr_default.execute(17, new Object[] {A16CityName, A9CountryId, A15CityId});
                        pr_default.close(17);
                        dsDefault.SmartCacheProvider.SetUpdated("CountryCity");
      ...
      protected void OnDeleteControls035( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(19, new Object[] {A9CountryId, A15CityId});
            ...
            pr_default.execute(20, new Object[] {A9CountryId, A15CityId});
      ...
      protected void SendRow035( )
      {
         ...
         Gridcountry_cityRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCityId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A15CityId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A15CityId), "ZZZ9"))," inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,54);\"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCityId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtCityId_Enabled,(short)1,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)53,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
         /* Subfile cell */
         /* Single line edit */
      ...
      protected void ReadRow035( )
      {
         ...
         GXCCtl = "Z15CityId_" + sGXsfl_53_idx;
         Z15CityId = (short)(context.localUtil.CToN( cgiGet( GXCCtl), ".", ","));
         GXCCtl = "Z16CityName_" + sGXsfl_53_idx;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510212450", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510212458", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("country.js", "?202361510212458", false, true);
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000310", "INSERT INTO [Country]([CountryName], [CountryLastLine]) VALUES(@CountryName, @CountryLastLine); SELECT SCOPE_IDENTITY()", GxErrorMask.GX_NOMASK,prmT000310)
