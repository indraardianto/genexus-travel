...
namespace GeneXus.Programs {
   public class customer : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, ".", "")), StringUtil.LTrim( ((edtCustomerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtCustomerLastName_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtCustomerAddress_Internalname, A4CustomerAddress, "http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4CustomerAddress), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", 0, 1, edtCustomerAddress_Enabled, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "", "1024", -1, 0, "_blank", "", 0, true, "GeneXus\\Address", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerEmail_Internalname, A6CustomerEmail, StringUtil.RTrim( context.localUtil.Format( A6CustomerEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "mailto:"+A6CustomerEmail, "", "", "", edtCustomerEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "GeneXus\\Email", "left", true, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtCustomerAddedDate_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerAddedDate_Internalname, context.localUtil.Format(A14CustomerAddedDate, "99/99/99"), context.localUtil.Format( A14CustomerAddedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerAddedDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerAddedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Customer.htm");
         GxWebStd.gx_bitmap( context, edtCustomerAddedDate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtCustomerAddedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Customer.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z1CustomerId = (short)(context.localUtil.CToN( cgiGet( "Z1CustomerId"), ".", ","));
            ...
            Z14CustomerAddedDate = context.localUtil.CToD( cgiGet( "Z14CustomerAddedDate"), 0);
            ...
            A14CustomerAddedDate = context.localUtil.CToD( cgiGet( edtCustomerAddedDate_Internalname), 1);
            AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
            ...
            A14CustomerAddedDate = context.localUtil.CToD( cgiGet( edtCustomerAddedDate_Internalname), 1);
            AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
            forbiddenHiddens.Add("CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
            hsh = cgiGet( "hsh");
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A1CustomerId = (short)(NumberUtil.Val( GetPar( "CustomerId"), "."));
               AssignAttri("", false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
               getEqualNoModal( ) ;
               Gx_mode = "DSP";
               AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void ZM011( short GX_JID )
      {
         if ( ( GX_JID == 7 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z14CustomerAddedDate = T00013_A14CustomerAddedDate[0];
            }
            else
            {
               ...
               Z14CustomerAddedDate = A14CustomerAddedDate;
            }
         }
         if ( GX_JID == -7 )
         {
      ...
      {
         if ( IsIns( )  && (DateTime.MinValue==A14CustomerAddedDate) && ( Gx_BScreen == 0 ) )
         {
            A14CustomerAddedDate = Gx_date;
            AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
         }
         else
         {
      ...
      protected void Load011( )
      {
         ...
         if ( (pr_default.getStatus(2) != 101) )
         {
            ...
            AssignAttri("", false, "A6CustomerEmail", A6CustomerEmail);
            A14CustomerAddedDate = T00014_A14CustomerAddedDate[0];
            AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
            ZM011( -7) ;
         }
         pr_default.close(2);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A6CustomerEmail", A6CustomerEmail);
            A14CustomerAddedDate = T00013_A14CustomerAddedDate[0];
            AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
            Z1CustomerId = A1CustomerId;
            sMode1 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void CheckOptimisticConcurrency011( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( DateTimeUtil.ResetTime ( Z14CustomerAddedDate ) != DateTimeUtil.ResetTime ( T00012_A14CustomerAddedDate[0] ) ) )
            {
               ...
               if ( DateTimeUtil.ResetTime ( Z14CustomerAddedDate ) != DateTimeUtil.ResetTime ( T00012_A14CustomerAddedDate[0] ) )
               {
                  GXUtil.WriteLog("customer:[seudo value changed for attri]"+"CustomerAddedDate");
                  GXUtil.WriteLogRaw("Old: ",Z14CustomerAddedDate);
                  GXUtil.WriteLogRaw("Current: ",T00012_A14CustomerAddedDate[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00018 */
                     pr_default.execute(6, new Object[] {A2CustomerName, A3CustomerLastName, A4CustomerAddress, A5CustomerPhone, A6CustomerEmail, A14CustomerAddedDate});
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00019 */
                     pr_default.execute(7, new Object[] {A2CustomerName, A3CustomerLastName, A4CustomerAddress, A5CustomerPhone, A6CustomerEmail, A14CustomerAddedDate, A1CustomerId});
                     pr_default.close(7);
                     dsDefault.SmartCacheProvider.SetUpdated("Customer");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510212173", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z14CustomerAddedDate", context.localUtil.DToC( Z14CustomerAddedDate, 0, "/"));
      ...
      protected void InitializeNonKey011( )
      {
         ...
         Z5CustomerPhone = "";
         Z6CustomerEmail = "";
         Z14CustomerAddedDate = DateTime.MinValue;
      }
      ...
      {
         A14CustomerAddedDate = i14CustomerAddedDate;
         AssignAttri("", false, "A14CustomerAddedDate", context.localUtil.Format(A14CustomerAddedDate, "99/99/99"));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510212180", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?202361510212180", false, true);
      ...
      public void Valid_Customerid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z5CustomerPhone", StringUtil.RTrim( Z5CustomerPhone));
         GxWebStd.gx_hidden_field( context, "Z6CustomerEmail", Z6CustomerEmail);
         GxWebStd.gx_hidden_field( context, "Z14CustomerAddedDate", context.localUtil.Format(Z14CustomerAddedDate, "99/99/99"));
         AssignProp("", false, bttBtn_delete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_delete_Enabled), 5, 0), true);
         AssignProp("", false, bttBtn_enter_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_enter_Enabled), 5, 0), true);
         SendCloseFormHiddens( ) ;
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A14CustomerAddedDate',fld:'CUSTOMERADDEDDATE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERID","{handler:'Valid_Customerid',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'Gx_date',fld:'vTODAY',pic:''},{av:'Gx_BScreen',fld:'vGXBSCREEN',pic:'9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'A14CustomerAddedDate',fld:'CUSTOMERADDEDDATE',pic:''}]");
         setEventMetadata("VALID_CUSTOMERID",",oparms:[{av:'A2CustomerName',fld:'CUSTOMERNAME',pic:''},{av:'A3CustomerLastName',fld:'CUSTOMERLASTNAME',pic:''},{av:'A4CustomerAddress',fld:'CUSTOMERADDRESS',pic:''},{av:'A5CustomerPhone',fld:'CUSTOMERPHONE',pic:''},{av:'A6CustomerEmail',fld:'CUSTOMEREMAIL',pic:''},{av:'A14CustomerAddedDate',fld:'CUSTOMERADDEDDATE',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z1CustomerId'},{av:'Z2CustomerName'},{av:'Z3CustomerLastName'},{av:'Z4CustomerAddress'},{av:'Z5CustomerPhone'},{av:'Z6CustomerEmail'},{av:'Z14CustomerAddedDate'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
      ...
      public override void initialize( )
      {
         ...
         T00014_A14CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         ...
         T00013_A14CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         sMode1 = "";
         ...
         T00012_A14CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         T00018_A1CustomerId = new short[1] ;
         T000111_A1CustomerId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         i14CustomerAddedDate = DateTime.MinValue;
         ZZ2CustomerName = "";
         ZZ3CustomerLastName = "";
         ZZ4CustomerAddress = "";
         ZZ5CustomerPhone = "";
         ZZ6CustomerEmail = "";
         ZZ14CustomerAddedDate = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customer__default(),
            new Object[][] {
                new Object[] {
               T00012_A1CustomerId, T00012_A2CustomerName, T00012_A3CustomerLastName, T00012_A4CustomerAddress, T00012_A5CustomerPhone, T00012_A6CustomerEmail, T00012_A14CustomerAddedDate
               }
               , new Object[] {
               T00013_A1CustomerId, T00013_A2CustomerName, T00013_A3CustomerLastName, T00013_A4CustomerAddress, T00013_A5CustomerPhone, T00013_A6CustomerEmail, T00013_A14CustomerAddedDate
               }
               , new Object[] {
               T00014_A1CustomerId, T00014_A2CustomerName, T00014_A3CustomerLastName, T00014_A4CustomerAddress, T00014_A5CustomerPhone, T00014_A6CustomerEmail, T00014_A14CustomerAddedDate
               }
               , new Object[] {
               T00015_A1CustomerId
               }
      ...
      private DateTime Z14CustomerAddedDate ;
      private DateTime A14CustomerAddedDate ;
      private DateTime Gx_date ;
      private DateTime i14CustomerAddedDate ;
      private DateTime ZZ14CustomerAddedDate ;
      ...
      private DateTime[] T00014_A14CustomerAddedDate ;
      ...
      private DateTime[] T00013_A14CustomerAddedDate ;
      ...
      private DateTime[] T00012_A14CustomerAddedDate ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T00018", "INSERT INTO [Customer]([CustomerName], [CustomerLastName], [CustomerAddress], [CustomerPhone], [CustomerEmail], [CustomerAddedDate]) VALUES(@CustomerName, @CustomerLastName, @CustomerAddress, @CustomerPhone, @CustomerEmail, @CustomerAddedDate); SELECT SCOPE_IDENTITY()", GxErrorMask.GX_NOMASK,prmT00018)
