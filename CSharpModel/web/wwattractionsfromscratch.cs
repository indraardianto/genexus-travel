...
namespace GeneXus.Programs {
   public class wwattractionsfromscratch : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwattractionsfromscratch( )
      {
      ...
      public wwattractionsfromscratch( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( AV5CountryId, AV6AttractionNameForm, AV7AttractionNameTo, AV10update, AV11newTrip, AV9totalTrips) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361511141881", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwattractionsfromscratch.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"WWAttractionsFromScratch");
         forbiddenHiddens.Add("totalTrips", context.localUtil.Format( (decimal)(AV9totalTrips), "ZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("wwattractionsfromscratch:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("wwattractionsfromscratch.aspx")  ;
      }
      ...
      {
         return "WWAttractions From Scratch" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCountryid, dynavCountryid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5CountryId), 4, 0)), 1, dynavCountryid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCountryid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,8);\"", "", true, 1, "HLP_WWAttractionsFromScratch.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAttractionnameform_Internalname, StringUtil.RTrim( AV6AttractionNameForm), StringUtil.RTrim( context.localUtil.Format( AV6AttractionNameForm, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAttractionnameform_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavAttractionnameform_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttractionsFromScratch.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAttractionnameto_Internalname, StringUtil.RTrim( AV7AttractionNameTo), StringUtil.RTrim( context.localUtil.Format( AV7AttractionNameTo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAttractionnameto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavAttractionnameto_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttractionsFromScratch.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTotaltrips_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9totalTrips), 4, 0, ".", "")), StringUtil.LTrim( ((edtavTotaltrips_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9totalTrips), "ZZZ9") : context.localUtil.Format( (decimal)(AV9totalTrips), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTotaltrips_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTotaltrips_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWAttractionsFromScratch.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WWAttractions From Scratch", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvCOUNTRYID0X2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvCOUNTRYID_html0X2( )
      {
      ...
      protected void GXDLVvCOUNTRYID_data0X2( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H000X2_A9CountryId[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H000X2_A10CountryName[0]));
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000X4 */
            pr_default.execute(1, new Object[] {AV5CountryId, AV6AttractionNameForm, AV7AttractionNameTo});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A9CountryId = H000X4_A9CountryId[0];
               A40001AttractionPhoto_GXI = H000X4_A40001AttractionPhoto_GXI[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40001AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A10CountryName = H000X4_A10CountryName[0];
               A8AttractionName = H000X4_A8AttractionName[0];
               A7AttractionId = H000X4_A7AttractionId[0];
               A40000GXC1 = H000X4_A40000GXC1[0];
               n40000GXC1 = H000X4_n40000GXC1[0];
               A13AttractionPhoto = H000X4_A13AttractionPhoto[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40001AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A10CountryName = H000X4_A10CountryName[0];
               A40000GXC1 = H000X4_A40000GXC1[0];
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("wwattractionsfromscratch:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236151114198", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwattractionsfromscratch.js", "?20236151114198", false, true);
      ...
      protected void sendrow_242( )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute";
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAttractionName_Internalname,StringUtil.RTrim( A8AttractionName),(string)"",(string)"","'"+""+"'"+",false,"+"'"+"e150x2_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAttractionName_Jsonclick,(short)7,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WWAttractions From Scratch";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VUPDATE.CLICK","{handler:'E160X2',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("VUPDATE.CLICK",",oparms:[{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]}");
         setEventMetadata("VNEWTRIP.CLICK","{handler:'E140X2',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'AV6AttractionNameForm',fld:'vATTRACTIONNAMEFORM',pic:''},{av:'AV7AttractionNameTo',fld:'vATTRACTIONNAMETO',pic:''},{av:'AV10update',fld:'vUPDATE',pic:''},{av:'AV11newTrip',fld:'vNEWTRIP',pic:''},{av:'AV9totalTrips',fld:'vTOTALTRIPS',pic:'ZZZ9'},{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("ATTRACTIONNAME.CLICK","{handler:'E150X2',iparms:[{av:'A7AttractionId',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("ATTRACTIONNAME.CLICK",",oparms:[{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H000X2_A9CountryId = new short[1] ;
         H000X2_A10CountryName = new string[] {""} ;
         H000X4_A9CountryId = new short[1] ;
         H000X4_A40001AttractionPhoto_GXI = new string[] {""} ;
         H000X4_A10CountryName = new string[] {""} ;
         H000X4_A8AttractionName = new string[] {""} ;
         H000X4_A7AttractionId = new short[1] ;
         H000X4_A40000GXC1 = new int[1] ;
         H000X4_n40000GXC1 = new bool[] {false} ;
         H000X4_A13AttractionPhoto = new string[] {""} ;
         hsh = "";
         ...
         StyleString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwattractionsfromscratch__default(),
            new Object[][] {
                new Object[] {
               H000X2_A9CountryId, H000X2_A10CountryName
               }
               , new Object[] {
               H000X4_A9CountryId, H000X4_A40001AttractionPhoto_GXI, H000X4_A10CountryName, H000X4_A8AttractionName, H000X4_A7AttractionId, H000X4_A40000GXC1, H000X4_n40000GXC1, H000X4_A13AttractionPhoto
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H000X2_A9CountryId ;
      private string[] H000X2_A10CountryName ;
      private short[] H000X4_A9CountryId ;
      private string[] H000X4_A40001AttractionPhoto_GXI ;
      private string[] H000X4_A10CountryName ;
      private string[] H000X4_A8AttractionName ;
      private short[] H000X4_A7AttractionId ;
      private int[] H000X4_A40000GXC1 ;
      private bool[] H000X4_n40000GXC1 ;
      private string[] H000X4_A13AttractionPhoto ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class wwattractionsfromscratch__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000X4( IGxContext context ,
                                             short AV5CountryId ,
                                             string AV6AttractionNameForm ,
                                             string AV7AttractionNameTo ,
                                             short A9CountryId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H000X4(context, (short)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT [CountryId], [CountryName] FROM [Country] ORDER BY [CountryName] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000X4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X4,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
