...
namespace GeneXus.Programs {
   public class viewattraction : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510213481", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Attraction1wc == null ) )
         {
            WebComp_Attraction1wc.componentjscripts();
         }
      }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Attraction Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Attractions", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewAttraction.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAttractionName_Internalname, StringUtil.RTrim( A8AttractionName), StringUtil.RTrim( context.localUtil.Format( A8AttractionName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAttractionName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtAttractionName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAttraction_title_Internalname, "Supplier", "", "", lblAttraction_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewAttraction.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableattraction_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Attractionwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAttraction1_title_Internalname, "Trip", "", "", lblAttraction1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewAttraction.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Attraction1") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel3"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableattraction1_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Attraction1wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0046"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Attraction1wc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttraction1wc), StringUtil.Lower( WebComp_Attraction1wc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
                  }
                  WebComp_Attraction1wc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttraction1wc), StringUtil.Lower( WebComp_Attraction1wc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 38 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Attractionwc_Component) != 0 )
                           {
                              WebComp_Attractionwc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Attractionwc_Component = OldAttractionwc;
                        }
                        else if ( nCmpId == 46 )
                        {
                           OldAttraction1wc = cgiGet( "W0046");
                           if ( ( StringUtil.Len( OldAttraction1wc) == 0 ) || ( StringUtil.StrCmp(OldAttraction1wc, WebComp_Attraction1wc_Component) != 0 ) )
                           {
                              WebComp_Attraction1wc = getWebComponent(GetType(), "GeneXus.Programs", OldAttraction1wc, new Object[] {context} );
                              WebComp_Attraction1wc.ComponentInit();
                              WebComp_Attraction1wc.Name = "OldAttraction1wc";
                              WebComp_Attraction1wc_Component = OldAttraction1wc;
                           }
                           if ( StringUtil.Len( WebComp_Attraction1wc_Component) != 0 )
                           {
                              WebComp_Attraction1wc.componentprocess("W0046", "", sEvt);
                           }
                           WebComp_Attraction1wc_Component = OldAttraction1wc;
                        }
                     }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Attraction1wc_Component) != 0 )
               {
                  WebComp_Attraction1wc.componentstart();
               }
            }
         }
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7AttractionId = H000J2_A7AttractionId[0];
               A8AttractionName = H000J2_A8AttractionName[0];
      ...
      protected void E110J2( )
      {
         ...
         {
            A7AttractionId = H000J3_A7AttractionId[0];
            A8AttractionName = H000J3_A8AttractionName[0];
            AssignAttri("", false, "A8AttractionName", A8AttractionName);
            AV16GXLvl6 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Attraction") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Attractionwc_Component) != 0 )
            {
               ...
               WebComp_Attractionwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12AttractionId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Attraction1") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Attraction1wc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Attraction1wc_Component), StringUtil.Lower( "AttractionAttraction1WC")) != 0 )
            {
               WebComp_Attraction1wc = getWebComponent(GetType(), "GeneXus.Programs", "attractionattraction1wc", new Object[] {context} );
               WebComp_Attraction1wc.ComponentInit();
               WebComp_Attraction1wc.Name = "AttractionAttraction1WC";
               WebComp_Attraction1wc_Component = "AttractionAttraction1WC";
            }
            if ( StringUtil.Len( WebComp_Attraction1wc_Component) != 0 )
            {
               WebComp_Attraction1wc.setjustcreated();
               WebComp_Attraction1wc.componentprepare(new Object[] {(string)"W0046",(string)"",(short)AV12AttractionId});
               WebComp_Attraction1wc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Attraction1wc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
               WebComp_Attraction1wc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Attraction1wc == null ) )
         {
            if ( StringUtil.Len( WebComp_Attraction1wc_Component) != 0 )
            {
               WebComp_Attraction1wc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20236151021353", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewattraction.js", "?20236151021353", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblAttraction1_title_Internalname = "ATTRACTION1_TITLE";
         divTableattraction1_Internalname = "TABLEATTRACTION1";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12AttractionId',fld:'vATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A8AttractionName',fld:'ATTRACTIONNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         OldAttractionwc = "";
         lblAttraction1_title_Jsonclick = "";
         WebComp_Attraction1wc_Component = "";
         OldAttraction1wc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000J2_A7AttractionId = new short[1] ;
         H000J2_A8AttractionName = new string[] {""} ;
         hsh = "";
         H000J3_A7AttractionId = new short[1] ;
         H000J3_A8AttractionName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewattraction__default(),
            new Object[][] {
                new Object[] {
               H000J2_A7AttractionId, H000J2_A8AttractionName
               }
               , new Object[] {
               H000J3_A7AttractionId, H000J3_A8AttractionName
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Attractionwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Attraction1wc = new GeneXus.Http.GXNullWebComponent();
         AV15Pgmname = "ViewAttraction";
         /* GeneXus formulas. */
         AV15Pgmname = "ViewAttraction";
         context.Gx_err = 0;
      ...
      private string lblAttraction1_title_Internalname ;
      private string lblAttraction1_title_Jsonclick ;
      private string divTableattraction1_Internalname ;
      private string WebComp_Attraction1wc_Component ;
      private string OldAttraction1wc ;
      private string sEvt ;
      ...
      private bool bDynCreated_Attraction1wc ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Attractionwc ;
      private GXWebComponent WebComp_Attraction1wc ;
      private GXProperties forbiddenHiddens ;
      private GXUserControl ucTab ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] H000J2_A7AttractionId ;
      private string[] H000J2_A8AttractionName ;
      private short[] H000J3_A7AttractionId ;
      private string[] H000J3_A8AttractionName ;
   ...
   public class viewattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000J2", "SELECT [AttractionId], [AttractionName] FROM [Attraction] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000J3", "SELECT [AttractionId], [AttractionName] FROM [Attraction] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
