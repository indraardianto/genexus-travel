...
namespace GeneXus.Programs {
   public class aattractionlist : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         aattractionlist objaattractionlist;
         objaattractionlist = new aattractionlist();
         objaattractionlist.AV8CountryId = aP0_CountryId;
         objaattractionlist.context.SetSubmitInitialConfig(context);
         objaattractionlist.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objaattractionlist);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((aattractionlist)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A9CountryId = P000E2_A9CountryId[0];
               A40000AttractionPhoto_GXI = P000E2_A40000AttractionPhoto_GXI[0];
               A8AttractionName = P000E2_A8AttractionName[0];
               A7AttractionId = P000E2_A7AttractionId[0];
               A10CountryName = P000E2_A10CountryName[0];
               A13AttractionPhoto = P000E2_A13AttractionPhoto[0];
               A10CountryName = P000E2_A10CountryName[0];
               H0E0( false, 100) ;
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm = "";
         scmdbuf = "";
         P000E2_A9CountryId = new short[1] ;
         P000E2_A40000AttractionPhoto_GXI = new string[] {""} ;
         P000E2_A8AttractionName = new string[] {""} ;
         P000E2_A7AttractionId = new short[1] ;
         P000E2_A10CountryName = new string[] {""} ;
         P000E2_A13AttractionPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aattractionlist__default(),
            new Object[][] {
                new Object[] {
               P000E2_A9CountryId, P000E2_A40000AttractionPhoto_GXI, P000E2_A8AttractionName, P000E2_A7AttractionId, P000E2_A10CountryName, P000E2_A13AttractionPhoto
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P000E2_A9CountryId ;
      private string[] P000E2_A40000AttractionPhoto_GXI ;
      private string[] P000E2_A8AttractionName ;
      private short[] P000E2_A7AttractionId ;
      private string[] P000E2_A10CountryName ;
      private string[] P000E2_A13AttractionPhoto ;
   }
   ...
   public class aattractionlist__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000E2", "SELECT T1.[CountryId], T1.[AttractionPhoto_GXI], T1.[AttractionName], T1.[AttractionId], T2.[CountryName], T1.[AttractionPhoto] FROM ([Attraction] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[CountryId] = @AV8CountryId ORDER BY T2.[CountryName] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000E2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
