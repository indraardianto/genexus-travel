...
namespace GeneXus.Programs {
   public class category_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "Traveling") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtCategory> aP0_ReturnValue )
      {
         ...
         objcategory_dataprovider.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "Traveling") ;
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "Traveling");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
