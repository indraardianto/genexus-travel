...
namespace GeneXus.Programs {
   public class wwattractionsfromscratch2 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwattractionsfromscratch2( )
      {
      ...
      public wwattractionsfromscratch2( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( AV5CountryId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510213634", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwattractionsfromscratch2.aspx") +"\">") ;
      ...
      {
         return formatLink("wwattractionsfromscratch2.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWAttractionsFromScratch2" ;
      }

      public override string GetPgmdesc( )
      {
         return "WWAttractions From Scratch2" ;
      }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCountryid, dynavCountryid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5CountryId), 4, 0)), 1, dynavCountryid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCountryid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,8);\"", "", true, 1, "HLP_WWAttractionsFromScratch2.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAttractionnameform_Internalname, StringUtil.RTrim( AV6AttractionNameForm), StringUtil.RTrim( context.localUtil.Format( AV6AttractionNameForm, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAttractionnameform_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavAttractionnameform_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttractionsFromScratch2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAttractionnameto_Internalname, StringUtil.RTrim( AV7AttractionNameTo), StringUtil.RTrim( context.localUtil.Format( AV7AttractionNameTo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAttractionnameto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavAttractionnameto_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttractionsFromScratch2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTotaltrips_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9totalTrips), 4, 0, ".", "")), StringUtil.LTrim( ((edtavTotaltrips_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9totalTrips), "ZZZ9") : context.localUtil.Format( (decimal)(AV9totalTrips), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTotaltrips_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTotaltrips_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWAttractionsFromScratch2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START142( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WWAttractions From Scratch2", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40000AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_24_Refreshing);
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV10update)) ? AV18Update_GXI : context.convertURL( context.PathToRelativeUrl( AV10update))), !bGXsfl_24_Refreshing);
      ...
      protected void GXDLVvCOUNTRYID142( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvCOUNTRYID_html142( )
      {
      ...
      protected void GXDLVvCOUNTRYID_data142( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00142_A9CountryId[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00142_A10CountryName[0]));
      ...
      protected void RF142( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9CountryId = H00143_A9CountryId[0];
               A40000AttractionPhoto_GXI = H00143_A40000AttractionPhoto_GXI[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40000AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A10CountryName = H00143_A10CountryName[0];
               A8AttractionName = H00143_A8AttractionName[0];
               A7AttractionId = H00143_A7AttractionId[0];
               A13AttractionPhoto = H00143_A13AttractionPhoto[0];
               AssignProp("", false, edtAttractionPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A13AttractionPhoto)) ? A40000AttractionPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A13AttractionPhoto))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtAttractionPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A13AttractionPhoto), true);
               A10CountryName = H00143_A10CountryName[0];
               /* Execute user event: Load */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510213656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwattractionsfromscratch2.js", "?202361510213656", false, true);
         }
      ...
      protected void sendrow_242( )
      {
         ...
         ClassString = "Image";
         StyleString = "";
         AV10update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV10update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV18Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV10update)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV10update)) ? AV18Update_GXI : context.PathToRelativeUrl( AV10update));
         Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdate_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)AV10update_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute";
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavNewtrip_Internalname,StringUtil.RTrim( AV11newTrip),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavNewtrip_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)-1,(int)edtavNewtrip_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WWAttractions From Scratch2";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'dynavCountryid'},{av:'AV5CountryId',fld:'vCOUNTRYID',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00142_A9CountryId = new short[1] ;
         H00142_A10CountryName = new string[] {""} ;
         H00143_A9CountryId = new short[1] ;
         H00143_A40000AttractionPhoto_GXI = new string[] {""} ;
         H00143_A10CountryName = new string[] {""} ;
         H00143_A8AttractionName = new string[] {""} ;
         H00143_A7AttractionId = new short[1] ;
         H00143_A13AttractionPhoto = new string[] {""} ;
         ...
         StyleString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwattractionsfromscratch2__default(),
            new Object[][] {
                new Object[] {
               H00142_A9CountryId, H00142_A10CountryName
               }
               , new Object[] {
               H00143_A9CountryId, H00143_A40000AttractionPhoto_GXI, H00143_A10CountryName, H00143_A8AttractionName, H00143_A7AttractionId, H00143_A13AttractionPhoto
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H00142_A9CountryId ;
      private string[] H00142_A10CountryName ;
      private short[] H00143_A9CountryId ;
      private string[] H00143_A40000AttractionPhoto_GXI ;
      private string[] H00143_A10CountryName ;
      private string[] H00143_A8AttractionName ;
      private short[] H00143_A7AttractionId ;
      private string[] H00143_A13AttractionPhoto ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class wwattractionsfromscratch2__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00142", "SELECT [CountryId], [CountryName] FROM [Country] ORDER BY [CountryName] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00142,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00143", "SELECT T1.[CountryId], T1.[AttractionPhoto_GXI], T2.[CountryName], T1.[AttractionName], T1.[AttractionId], T1.[AttractionPhoto] FROM ([Attraction] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) ORDER BY T1.[AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00143,11, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
