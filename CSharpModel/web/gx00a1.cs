...
namespace GeneXus.Programs {
   public class gx00a1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV9pFlightId = (short)(NumberUtil.Val( GetPar( "pFlightId"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV10pFlightSeatId = (short)(NumberUtil.Val( GetPar( "pFlightSeatId"), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202361510214034", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00a1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlightId,4,0)),UrlEncode(StringUtil.LTrimStr(AV10pFlightSeatId,4,0)),UrlEncode(StringUtil.RTrim(AV11pFlightSeatChar))}, new string[] {"pFlightId","pFlightSeatId","pFlightSeatChar"}) +"\">") ;
      ...
      {
         return formatLink("gx00a1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pFlightId,4,0)),UrlEncode(StringUtil.LTrimStr(AV10pFlightSeatId,4,0)),UrlEncode(StringUtil.RTrim(AV11pFlightSeatChar))}, new string[] {"pFlightId","pFlightSeatId","pFlightSeatChar"})  ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightseatidfilter_Internalname, "Flight Seat Id", "", "", lblLblflightseatidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110q1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00A1.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFlightseatcharfiltercontainer_Internalname, 1, 0, "px", 0, "px", divFlightseatcharfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightseatcharfilter_Internalname, "Flight Seat Char", "", "", lblLblflightseatcharfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120q1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00A1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblflightseatlocationfilter_Internalname, "Flight Seat Location", "", "", lblLblflightseatlocationfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130q1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00A1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCflightseatlocation, cmbavCflightseatlocation_Internalname, StringUtil.RTrim( AV8cFlightSeatLocation), 1, cmbavCflightseatlocation_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavCflightseatlocation.Visible, cmbavCflightseatlocation.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "", true, 1, "HLP_Gx00A1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e140q1_client"+"'", TempTags, "", 2, "HLP_Gx00A1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A43FlightSeatChar));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavLinkselection_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5LinkSelection)) ? AV15Linkselection_GXI : context.convertURL( context.PathToRelativeUrl( AV5LinkSelection))), !bGXsfl_44_Refreshing);
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FLIGHTSEATCHAR", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A43FlightSeatChar, "")), context));
         GxWebStd.gx_hidden_field( context, "FLIGHTSEATCHAR", StringUtil.RTrim( A43FlightSeatChar));
      }
      ...
      protected void RF0Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19FlightId = H000Q2_A19FlightId[0];
               A41FlightSeatLocation = H000Q2_A41FlightSeatLocation[0];
               A43FlightSeatChar = H000Q2_A43FlightSeatChar[0];
               A40FlightSeatId = H000Q2_A40FlightSeatId[0];
               /* Execute user event: Load */
               E160Q2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_FLIGHTSEATID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A40FlightSeatId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FLIGHTSEATCHAR"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, StringUtil.RTrim( context.localUtil.Format( A43FlightSeatChar, "")), context));
      }
      ...
      protected void E170Q2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV10pFlightSeatId = A40FlightSeatId;
         AssignAttri("", false, "AV10pFlightSeatId", StringUtil.LTrimStr( (decimal)(AV10pFlightSeatId), 4, 0));
         AV11pFlightSeatChar = A43FlightSeatChar;
         AssignAttri("", false, "AV11pFlightSeatChar", AV11pFlightSeatChar);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202361510214068", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00a1.js", "?202361510214068", false, true);
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A40FlightSeatId), 4, 0, ".", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A43FlightSeatChar))+"'"+"]);";
            ...
            /* ComboBox */
            Grid1Row.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbFlightSeatChar,(string)cmbFlightSeatChar_Internalname,StringUtil.RTrim( A43FlightSeatChar),(short)1,(string)cmbFlightSeatChar_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"char",(string)"",(short)-1,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",(string)"",(string)"",(bool)true,(short)1});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E140Q1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLFLIGHTSEATIDFILTER.CLICK","{handler:'E110Q1',iparms:[{av:'divFlightseatidfiltercontainer_Class',ctrl:'FLIGHTSEATIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFLIGHTSEATCHARFILTER.CLICK","{handler:'E120Q1',iparms:[{av:'divFlightseatcharfiltercontainer_Class',ctrl:'FLIGHTSEATCHARFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFLIGHTSEATLOCATIONFILTER.CLICK","{handler:'E130Q1',iparms:[{av:'divFlightseatlocationfiltercontainer_Class',ctrl:'FLIGHTSEATLOCATIONFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E170Q2',iparms:[{av:'A40FlightSeatId',fld:'FLIGHTSEATID',pic:'ZZZ9',hsh:true},{av:'cmbFlightSeatChar'},{av:'A43FlightSeatChar',fld:'FLIGHTSEATCHAR',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H000Q2_A19FlightId = new short[1] ;
         H000Q2_A41FlightSeatLocation = new string[] {""} ;
         H000Q2_A43FlightSeatChar = new string[] {""} ;
         H000Q2_A40FlightSeatId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00a1__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A19FlightId, H000Q2_A41FlightSeatLocation, H000Q2_A43FlightSeatChar, H000Q2_A40FlightSeatId
               }
               , new Object[] {
      ...
      private short[] H000Q2_A19FlightId ;
      private string[] H000Q2_A41FlightSeatLocation ;
      private string[] H000Q2_A43FlightSeatChar ;
      private short[] H000Q2_A40FlightSeatId ;
   ...
   public class gx00a1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000Q2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H000Q3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
